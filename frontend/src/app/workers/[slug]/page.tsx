        ...
        <div className="grid lg:grid-cols-3 gap-12 lg:gap-20 items-start">
          ...
          <div className="lg:col-span-2 space-y-16">
            ...
            <motion.div
              ...
              className="relative bg-white border border-[#FED7AA]/30 rounded-[3.5rem] sm:rounded-[4.5rem] p-10 sm:p-20 shadow-2xl shadow-red-900/2 overflow-hidden"
            >
              {/* Background Accents */}
              ...
              <div className="flex flex-col md:flex-row items-center md:items-start gap-14 sm:gap-20 relative z-10">
                <div className="relative shrink-0">
                  <div className="relative w-56 h-56 sm:w-72 sm:h-72">
                    <div className="absolute inset-x-0 -bottom-10 h-20 bg-[#EA580C]/10 blur-2xl rounded-[4rem] group-hover:bg-[#EA580C]/20 transition-all" />
                    <div className="relative w-full h-full rounded-[4rem] sm:rounded-[5rem] overflow-hidden border-8 border-white shadow-[0_30px_60px_rgba(220,38,38,0.1)] ring-1 ring-[#FED7AA]/20 z-10 transition-transform hover:scale-105 duration-1000">
                      <Image
                        src={worker.photoUrl}
                        alt={worker.fullName}
                        fill
                  ...
                  <div className="absolute -bottom-6 left-1/2 -translate-x-1/2 md:left-auto md:translate-x-0 md:-right-6 z-20">
                    ...
                    >
                      ...
                      />
                      <span className="text-[11px] font-black uppercase tracking-[0.2em] whitespace-nowrap leading-none">
                ...
                <div className="flex-1 text-center md:text-left">
                  ...
                  >
                    <div className="inline-flex items-center gap-2.5 px-5 py-2.5 bg-emerald-500/5 text-emerald-600 rounded-full text-[10px] font-black uppercase tracking-[0.25em] mb-10 border border-emerald-500/10 mx-auto md:mx-0">
                      <ShieldCheck className="w-4 h-4" />
                      Tenaga Terverifikasi
                    </div>
                    <h1 className="text-6xl sm:text-8xl font-black text-[#1C0A00] tracking-tighter leading-[0.8] mb-8">
                      {worker.fullName.split(" ").map((name, i) => (
                        <span key={i} className="block">
                          {name}
                        </span>
                      ))}
                    </h1>
                    <p className="text-2xl sm:text-4xl font-black text-[#EA580C] mb-12 uppercase tracking-widest flex items-center justify-center md:justify-start gap-5">
                      <span className="w-12 h-px bg-[#EA580C]/30 hidden sm:block" />
                      {worker.category.name}
                    </p>

                    <div className="flex flex-col sm:flex-row items-center gap-5">
                      <div className="w-full sm:w-auto group flex items-center justify-center sm:justify-start gap-4 px-8 py-5 bg-[#FFF7F5] rounded-[2rem] border border-[#FED7AA]/30 hover:border-[#EA580C] transition-all hover:shadow-2xl hover:shadow-red-900/5">
                        <MapPin className="w-6 h-6 text-[#DC2626] group-hover:scale-110 transition-transform" />
                        <span className="text-base font-black text-[#78350F]">
                          {worker.location}
                        </span>
                      </div>
                      <div className="w-full sm:w-auto group flex items-center justify-center sm:justify-start gap-4 px-8 py-5 bg-[#FFF7F5] rounded-[2rem] border border-[#FED7AA]/30 hover:border-[#EA580C] transition-all hover:shadow-2xl hover:shadow-red-900/5">
                        <Zap className="w-6 h-6 text-[#EA580C] group-hover:scale-110 transition-transform" />
                        <span className="text-base font-black text-[#78350F]">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 sm:gap-10">
              {[
                ...
                <motion.div
                  ...
                  whileHover={{
                    y: -10,
                    boxShadow: "0 25px 50px rgba(220,38,38,0.08)",
                  }}
                  className="bg-white border border-[#FED7AA]/30 p-10 sm:p-12 rounded-[3rem] sm:rounded-[4rem] text-center shadow-2xl shadow-red-900/2 transition-all relative overflow-hidden group"
                >
                  ...
                  <div
                    className={`w-16 h-16 sm:w-24 sm:h-24 ${stat.bg} ${stat.color} rounded-[2rem] sm:rounded-[2.5rem] flex items-center justify-center mx-auto mb-8 border border-black/3 shadow-inner transform transition-transform group-hover:scale-110`}
                  >
                    <stat.icon className="w-8 h-8 sm:w-12 sm:h-12" />
                  </div>
                  <div className="text-3xl sm:text-5xl font-black text-[#1C0A00] mb-0 tracking-tighter">
                    {stat.value}
                  </div>
                  <div className="text-[12px] font-black text-[#78350F]/40 uppercase tracking-[0.25em] mt-2">
                    {stat.label}
                  </div>
                </motion.div>
              ))}
            ...
            <motion.div
              variants={itemVariants}
              className="bg-white border border-[#FED7AA]/30 rounded-[4rem] sm:rounded-[6rem] p-10 sm:p-20 shadow-2xl shadow-red-900/2 relative overflow-hidden"
            >
              ...
              <div className="mb-24 relative z-10">
                <div className="flex items-center gap-6 mb-12">
                  <div className="w-3 h-12 bg-[#DC2626] rounded-full shadow-2xl shadow-red-900/40" />
                  <h2 className="text-4xl sm:text-6xl font-black text-[#1C0A00] tracking-tighter">
                    Profil Singkat
                  </h2>
                </div>
                <div className="relative p-12 sm:p-20 bg-[#FFF7F5] rounded-[3.5rem] sm:rounded-[5rem] border border-[#FED7AA]/30 group transition-all duration-700 hover:border-[#DC2626]/20 shadow-inner">
                  <div className="absolute top-10 left-10 text-9xl text-[#EA580C]/5 font-serif leading-none italic select-none">
                    &ldquo;
                  </div>
                  <p className="text-[#1C0A00]/80 leading-[1.7] text-2xl sm:text-3xl font-medium italic relative z-10 tracking-tight">
                    {worker.bio}
                  </p>
                  <div className="absolute bottom-10 right-10 text-9xl text-[#EA580C]/5 font-serif leading-none transition-transform rotate-180 italic select-none">
                    &ldquo;
                  </div>
                </div>
              </div>
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-6 mb-12">
                  <div className="w-3 h-12 bg-[#EA580C] rounded-full shadow-2xl shadow-orange-900/40" />
                  <h2 className="text-4xl sm:text-6xl font-black text-[#1C0A00] tracking-tighter">
                    Keahlian Utama
                  </h2>
                </div>
                <div className="flex flex-wrap gap-5 sm:gap-6">
                  {worker.skills.map((skill, idx) => (
                    <motion.div
                      ...
                      viewport={{ once: true }}
                      className="group flex items-center gap-5 px-10 sm:px-14 py-6 sm:py-8 bg-[#FFF7F5] border border-[#FED7AA]/30 rounded-[2.5rem] sm:rounded-[3rem] text-[#78350F] font-black text-base sm:text-xl hover:border-[#EA580C] hover:bg-white hover:shadow-2xl hover:shadow-red-900/5 transition-all cursor-default relative overflow-hidden"
                    >
                      ...
                      <div className="w-9 h-9 rounded-full bg-emerald-500/10 flex items-center justify-center border border-emerald-500/20 group-hover:bg-emerald-500 group-hover:text-white transition-colors relative z-10">
              ...
              <div className="mt-24 pt-24 border-t border-[#FED7AA]/20 relative z-10">
                ...
                <div className="grid sm:grid-cols-3 gap-10">
                  {[
                    ...
                    <div
                      key={i}
                      className="flex flex-col items-center text-center p-8 bg-[#FFF7F5]/50 rounded-[2.5rem] border border-[#FED7AA]/20"
                    >
            ...
            <motion.div
              variants={itemVariants}
              className="px-12 sm:px-20 py-20 bg-linear-to-br from-[#1C0A00] to-black rounded-[4rem] sm:rounded-[6rem] text-white overflow-hidden relative shadow-2xl shadow-red-900/40"
            >
              ...
              <div className="relative z-10">
                ...
                <div className="grid md:grid-cols-2 gap-10">
                  {[1, 2].map((i) => (
                    <div
                      key={i}
                      className="p-12 bg-white/3 rounded-[3.5rem] border border-white/10 backdrop-blur-md hover:bg-white/5 transition-all duration-500 group"
                    >
                      ...
                      <p className="text-xl text-slate-300 font-medium italic leading-[1.6] mb-10 tracking-tight">
          ...
          <div className="space-y-12 lg:sticky lg:top-44">
            ...
            <motion.div
              variants={itemVariants}
              className="bg-[#1C0A00] rounded-[4rem] sm:rounded-[5rem] p-12 sm:p-16 shadow-[0_40px_100px_rgba(220,38,38,0.2)] relative overflow-hidden group"
            >
              ...
              <div className="relative z-10 text-center space-y-12">
                <div>
                  <div className="text-[#EA580C] text-[11px] font-black uppercase tracking-[0.6em] mb-10 block leading-none">
                    Investment Details
                  </div>
                  <h3 className="text-4xl sm:text-5xl font-black text-white tracking-tighter mb-6 leading-none">
                    Mulai Bekerja Sama
                  </h3>
                  <div className="w-20 h-2 bg-[#EA580C] rounded-full mx-auto" />
                </div>

                <div className="py-14 sm:py-16 bg-white/4 border border-white/10 rounded-[3.5rem] backdrop-blur-xl relative overflow-hidden group-hover:border-[#EA580C]/30 transition-all duration-700 shadow-inner">
                  <div className="text-white/40 text-[12px] font-black uppercase tracking-[0.45em] mb-6 leading-none">
                    Budget Per Hari
                  </div>
                  <div className="text-6xl sm:text-7xl font-black text-white tracking-tighter relative inline-flex items-start">
                    <span className="text-[#EA580C] text-3xl mt-3 mr-1.5 font-bold">
                      Rp
                    </span>
                ...
                <div className="space-y-5 pt-6">
                  <LinkNext
                    href="/contact"
                    className="flex items-center justify-center gap-4 w-full px-10 py-8 text-lg font-black text-white bg-[#DC2626] rounded-[2.5rem] hover:bg-[#B91C1C] transition-all shadow-2xl shadow-red-900/40 active:scale-[0.96] group overflow-hidden relative"
                  >
                    <div className="absolute inset-0 bg-linear-to-r from-white/0 via-white/10 to-white/0 -translate-x-full group-hover:translate-x-full transition-transform duration-1000" />
                    <MessageSquare className="w-6 h-6 group-hover:rotate-12 transition-transform" />
                    Hubungi via WhatsApp
                  </LinkNext>
                  <button className="flex items-center justify-center gap-4 w-full px-10 py-8 text-lg font-black text-white/80 border-2 border-white/10 rounded-[2.5rem] hover:bg-white hover:text-[#1C0A00] transition-all active:scale-[0.96] group">
                ...
                <div className="pt-12 border-t border-white/5 space-y-6">
                  {[
                    ...
                    <div
                      key={idx}
                      className="flex items-center gap-5 text-[12px] font-black text-white/40 uppercase tracking-[0.2em] text-left leading-tight group/item"
                    >
                      <div className="w-10 h-10 rounded-[1.25rem] bg-white/5 flex items-center justify-center shrink-0 border border-white/5 group-hover/item:border-[#EA580C]/20 transition-colors">
                        <item.icon
          ...
          <div className="mt-40 pt-40 border-t border-[#FED7AA]/30 relative">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-24 gap-12">
              <div className="max-w-2xl">
                <h2 className="text-5xl sm:text-8xl font-black text-[#1C0A00] tracking-tighter leading-[0.85] mb-8">
                  Mungkin Anda <br />{" "}
                  <span className="text-gradient">Juga Membutuhkan</span>
                </h2>
                <p className="text-[#78350F]/60 text-xl font-bold tracking-tight">
              ...
              <LinkNext
                href="/workers"
                className="inline-flex items-center gap-4 px-10 py-6 bg-white border-2 border-[#FED7AA]/30 rounded-[2rem] text-base font-black text-[#1C0A00] hover:bg-[#1C0A00] hover:text-white hover:border-[#1C0A00] transition-all shadow-xl shadow-red-900/2"
              >
